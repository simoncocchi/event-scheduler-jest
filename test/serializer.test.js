...
describe("Event Serializer",()=> {
    ...
    test('Test event serializer', async () => {
        ...
        expect(eventSerializer.serialize(event)).toStrictEqual('{"startTime":"2019-12-17T02:24:00.000Z","endTime":"2019-12-17T13:24:00","title":"Hello World","location":"Campus Numerique","description":"This is an hello world.."}');
    })
